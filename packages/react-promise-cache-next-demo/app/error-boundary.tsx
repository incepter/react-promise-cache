...
import {Hydration} from "react-promise-cache";
...
> {
  ...
  componentDidCatch(error, errorInfo) {
    console.log('__________________it did catch')
    this.setState((old) => ({
      ...old,
      error,
      errorInfo,
  ...
  render() {
    ...
    console.log('rendering error boundary !!', errorInfo)
